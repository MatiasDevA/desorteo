...
@Component({
  selector: 'app-sorteo-personalizado',
  templateUrl: './sorteo-personalizado.component.html',
  styleUrls: ['./sorteo-personalizado.component.css']
})
export class SorteoPersonalizadoComponent implements OnInit {
